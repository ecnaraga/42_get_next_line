...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   get_next_line_bonus_11_ok_a_rechecker_1_que        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: garance <garance@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/13 18:35:18 by garance           #+#    #+#             */
/*   Updated: 2023/05/14 18:13:15 by garance          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_get_next_line(int fd) // question : si BUFFERSIZE = 0 + fd = 0, est ce que le programe doit demander a l utilisateur d ecrire quelque chose sur l entree standard puis retourner null, ou retour null directement?
{
	char			*line;
